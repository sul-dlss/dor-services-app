...
RSpec.describe 'MODS name <--> cocina mappings' do
  ...
  describe 'Single namePart with displayForm' do
    it_behaves_like 'MODS cocina mapping' do
      let(:mods) do
        <<~XML
          <name type="personal">
            ...
            <displayForm>Holbein, Han, display form</displayForm>
          </name>
        XML
      end
              ...
              name: [
                {
                  parallelValue: [
                    ...
                    {
                      value: 'Holbein, Han, display form',
                      type: 'display'
                    }
                  ]
                }
  ...
  describe 'Name with additional subelements, including displayForm' do

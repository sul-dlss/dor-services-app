...
RSpec.describe 'MODS physicalDescription <--> cocina mappings' do
  ...
  describe 'Display label with multiple form' do
    xit 'not implemented - apply displayLabel to form' do
      let(:mods) do
        <<~XML
          <physicalDescription displayLabel="Medium">
            <form>metal embossed on wood</form>
      ...
      let(:cocina) do
        # MODS form doesn't have a displayLabel attribute, so it goes on the parent
        # element physicalDescription. Subelements with the same displayLabel go
        # in the same parent physicalDescription element.
        {
          form: [
            {
              value: 'metal embossed on wood',
  ...
  describe 'Multiple physicalDescription with different display labels' do
    xit 'not implemented - multiple display labels' do
      let(:mods) do
        <<~XML
          <physicalDescription displayLabel="Medium">
            <form>ink</form>
  ...
  describe 'Multiple form, some with displayLabel and some without' do
    xit 'not implemented - mixed form display labels' do
      let(:mods) do
        <<~XML
          <physicalDescription displayLabel="Medium">
            <form>metal embossed on wood</form>

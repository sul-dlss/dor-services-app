...
RSpec.describe CleanupService do
  ...
  describe '.stop_accessioning' do
    ...
    context 'when head version can be reopened' do
      ...
      context 'with revert_metadata param set to true' do
        it 'discards draft, backups, cleans up content, deletes workflows, and reverts metadata' do
          expect do
            described_class.stop_accessioning(druid, revert_metadata: true)

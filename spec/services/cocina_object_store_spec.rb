    ...
    describe '#create' do
      ...
      context 'when a DRO' do
        it 'maps and saves to Fedora' do
          ...
          expect(SynchronousIndexer).to have_received(:reindex_remotely_from_cocina).with(druid, cocina_object: cocina_object, created_at: kind_of(Time), updated_at: kind_of(Time))

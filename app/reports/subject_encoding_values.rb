...
# Report on values of subject.encoding.value.
# See: https://github.com/sul-dlss/dor-services-app/issues/6130
#
# Invoke via:
# bin/rails r -e production "SubjectEncodingValues.report"
class SubjectEncodingValues
  ...
  JSON_PATH = 'strict $.**.subject.**.encoding.value'

  SQL = <<~SQL.squish.freeze
    SELECT jsonb_path_query(rov.description, '#{JSON_PATH}') ->> 0 as value,

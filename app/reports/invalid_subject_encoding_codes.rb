...
# Invoke via:
# bin/rails r -e production "InvalidSubjectEncodingCodes.report"
class InvalidSubjectEncodingCodes
  ...
  JSON_PATH = 'strict $.**.subject.**.encoding.code'
  VALID_CODES = %w[edtf iso8601 marc temper w3cdtf].freeze

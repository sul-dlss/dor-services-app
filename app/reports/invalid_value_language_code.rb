...
# Invoke via:
# bin/rails r -e production "InvalidValueLanguageCode.report"
class InvalidValueLanguageCode
  ...
  JSON_PATH = 'strict $.**.valueLanguage.code'

  def self.valid_codes
    YAML.safe_load_file(
      "#{Gem.loaded_specs['cocina_display'].gem_dir}/config/searchworks_languages.yml"
    ).keys.compact
  end

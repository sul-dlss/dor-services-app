...
module Cocina
  ...
  class ModsNormalizer
    ...
    def normalize_name
      ...
      ng_xml.root.xpath('//mods:name[not(mods:namePart) and not(@xlink:href)]', mods: MODS_NS, xlink: XLINK_NS).each(&:remove)
      ...
      ng_xml.xpath('//mods:name[@xlink:href and mods:*]', mods: MODS_NS, xlink: XLINK_NS).each do |node|

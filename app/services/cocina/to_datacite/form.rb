...
module Cocina
  module ToDatacite
    # Transform the Cocina::Models::Description form attributes to the DataCite type attributes
    #  see https://support.datacite.org/reference/dois-2#put_dois-id
    class Form
      # @param [Cocina::Models::Description] cocina_desc
      # @return [Hash] Hash of DataCite type attributes, conforming to the expectations of HTTP PUT request to DataCite
      ...
      # @return [Hash] Hash of DataCite type attributes, conforming to the expectations of HTTP PUT request to DataCite
      def type_attributes
        return {} if cocina_desc&.form.nil?

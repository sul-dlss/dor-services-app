...
module Cocina
  ...
  class ObjectUpdater
    ...
    def validate
      ...
      raise NotImplemented, 'Updating descriptive metadata not supported' if obj.description.title.first.value != FromFedora::Descriptive::Titles.build(item).first[:value]
    end
